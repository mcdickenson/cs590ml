...
%%%%%
  Data was obtained for participants in the 2012 London Olympics from \textit{The Guardian}. The original data consisted of 10,383 participants, which was reduced to 8,856 observations after data processing. Of these, 6,956 participants were split into training ($n$=3,520) and test ($n$=3,436) sets for classification by sports ($k=27$). The remaining 1,900 Athletics participants were split into training ($n$=907) and test ($n$=993) sets for classification by event ($k=48)$. Participants' height, weight, age, and sex were used as features. Some sports and events exhibit relatively well-clustered features, whereas others are less defined.
...
%%%%%%
  \headerbox{\bf Classifying by Sport}{name=estimations,column=1,row=0}{
%%%%%
...
%%%%%%
  \headerbox{\bf Classifying by Event}{name=predictions,column=2,row=0}{
%%%%%
